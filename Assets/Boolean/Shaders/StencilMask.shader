...
ENDCG
    ...
    // write stencil only - draw on outside of mesh (this mesh is inversed)
    // without draw to depth and color buffer
    Pass {
        Stencil {
            Ref 1
            ReadMask 1
    ...
    // write depth with mask - draw intersection part with subRenderer
    Pass {
        Stencil {
            Ref 1
            ReadMask 1
    ...
    // clear part that is behide other subRenderer
    Pass {
        Stencil {
            Ref 1
            ReadMask 1
